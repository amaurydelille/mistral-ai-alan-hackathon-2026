...
export const last14Days: DayData[] = [
  // Week 1 — good baseline
  {
    ...
    activity: { steps: 7800, activeMin: 45, sedentaryHours: 8, workouts: ["yoga 30min"], burnedCalories: 2180, activeCal: 340, hrZoneLightMin: 240, hrZoneModerateMin: 45 },
  ...
  },
  {
    ...
    activity: { steps: 8200, activeMin: 38, sedentaryHours: 9, workouts: [], burnedCalories: 2150, activeCal: 320, hrZoneLightMin: 235, hrZoneModerateMin: 38 },
  ...
  },
  {
    ...
    activity: { steps: 9100, activeMin: 52, sedentaryHours: 8, workouts: ["walk 45min"], burnedCalories: 2220, activeCal: 380, hrZoneLightMin: 265, hrZoneModerateMin: 52 },
  ...
  // Week 2 — stress begins
  {
    ...
    activity: { steps: 5600, activeMin: 22, sedentaryHours: 10, workouts: [], burnedCalories: 2040, activeCal: 240, hrZoneLightMin: 210, hrZoneModerateMin: 28 },
  ...
  },
  {
    ...
    activity: { steps: 4800, activeMin: 18, sedentaryHours: 11, workouts: [], burnedCalories: 1980, activeCal: 200, hrZoneLightMin: 195, hrZoneModerateMin: 22 },
  ...
  },
  {
    ...
    activity: { steps: 4200, activeMin: 15, sedentaryHours: 12, workouts: [], burnedCalories: 1940, activeCal: 180, hrZoneLightMin: 185, hrZoneModerateMin: 18 },
  ...
  },
  {
    ...
    activity: { steps: 3800, activeMin: 14, sedentaryHours: 12, workouts: [], burnedCalories: 1900, activeCal: 160, hrZoneLightMin: 175, hrZoneModerateMin: 15 },
  ...
  // Week 3 — the spiral
  {
    ...
    activity: { steps: 3200, activeMin: 10, sedentaryHours: 13, workouts: [], burnedCalories: 1840, activeCal: 115, hrZoneLightMin: 165, hrZoneModerateMin: 9 },
  ...
  },
  {
    ...
    activity: { steps: 2800, activeMin: 8, sedentaryHours: 14, workouts: [], burnedCalories: 1800, activeCal: 85, hrZoneLightMin: 155, hrZoneModerateMin: 6 },
  ...
  },
  {
    ...
    activity: { steps: 3500, activeMin: 12, sedentaryHours: 12, workouts: [], burnedCalories: 1820, activeCal: 105, hrZoneLightMin: 168, hrZoneModerateMin: 8 },
  ...
  // Week 4 — partial recovery (following app advice)
  {
    ...
    activity: { steps: 4800, activeMin: 22, sedentaryHours: 11, workouts: ["walk 20min"], burnedCalories: 1950, activeCal: 195, hrZoneLightMin: 205, hrZoneModerateMin: 22 },
  ...
  },
  {
    ...
    activity: { steps: 5600, activeMin: 28, sedentaryHours: 10, workouts: ["walk 30min"], burnedCalories: 2000, activeCal: 235, hrZoneLightMin: 220, hrZoneModerateMin: 28 },
  ...
  // Yesterday — relapse under launch pressure
  {
    ...
    activity: { steps: 4100, activeMin: 15, sedentaryHours: 12, workouts: [], burnedCalories: 1870, activeCal: 155, hrZoneLightMin: 180, hrZoneModerateMin: 14 },
